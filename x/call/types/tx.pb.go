...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b9462d87a5cc38c, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b9462d87a5cc38c, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "call.call.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "call.call.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("call/call/tx.proto", fileDescriptor_1b9462d87a5cc38c) }

var fileDescriptor_1b9462d87a5cc38c = []byte{
	...
	0xae, 0xe6, 0x60, 0x33, 0xf4, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/call.call.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/call.call.Msg/UpdateParams",
	}
