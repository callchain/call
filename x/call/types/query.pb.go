...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_255cd9efd8ee3b04, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_255cd9efd8ee3b04, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "call.call.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "call.call.QueryParamsResponse")
}

func init() { proto.RegisterFile("call/call/query.proto", fileDescriptor_255cd9efd8ee3b04) }

var fileDescriptor_255cd9efd8ee3b04 = []byte{
	// 289 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x4d, 0x4e, 0xcc, 0xc9,
	...
	0x1c, 0x06, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x66, 0x06, 0x60, 0x89, 0xb2, 0x01, 0x00,
	0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/call.call.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/call.call.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "call/call/query.proto",
}
